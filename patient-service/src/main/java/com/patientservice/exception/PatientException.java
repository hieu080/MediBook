...
/**
 * Ngoại lệ nghiệp vụ dùng chung cho patient-service.
...
public class PatientException extends AppException {
    ...
    public PatientException(BaseErrorCode errorCode) {
        super(errorCode);
    }

    public PatientException(BaseErrorCode errorCode, String detail) {
        super(errorCode, detail);
    }

    public PatientException(BaseErrorCode errorCode, String detail, List<ErrorDetail> errors) {
